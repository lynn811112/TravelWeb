							...
							<table class="table  table-hover">
							  ...
							  <%
									...
									<tr>
										...
										<td><a href="/comment-edit.jsp"><i
												class="bi bi-pencil-square"></i>編輯</a> <a href="/comment-list.html>">Delete</a></td>
									</tr>
									<%
									}
									%>
							...
							<table id="bootstrap-data-table"
								...
								<tbody>
									...
									<tr>
										...
										<td><%=comment.getRate()%></td>
										<td><%=comment.getContent()%></td>
										<td><a href="/comment-list.jsp>"><i
												class="fa fa-pencil"></i></a> <a href="/comment-list.html>">Delete</a></td>
									</tr>
									<%
									}
									%>
